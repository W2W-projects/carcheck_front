...
<template>
  <report-wrapper>
    ...
    <!-- ------------------------------- -->
    <div class="flex flex-col items-center justify-start flex-1 space-y-2">
      <div class="flex flex-col items-center justify-start flex-1 space-y-2">
    ...
    <div v-show="isTableVisible" class="w-full space-y-4 text-black">
      <div class="flex flex-col items-center justify-center lg:flex-row">
        <div class="relative w-full md:w-7/12 lg:w-1/3">
          <chart-gauge v-if="failPercentage" :failRate="90" height="30" width="100%" />
      ...
      <table class="w-full mt-6 text-black">
          ...
          <tr class="header-row">
            <th colspan="2" class="bg-[#FF7400]">
              <div class="flex items-center justify-between w-full text-white">
                <button @click="prevSlide" class="flex items-center space-x-2 font-extralight">
                ...
                <button @click="nextSlide" class="flex items-center space-x-2 font-extralight">
        ...
        <tbody v-if="mostRecentMOT && !isMOThistoryLocked(motHistoryIndex)">
          ...
          <tr>
            <th>Results</th>
            <td>
              <p class="px-3 text-sm text-white rounded w-fit"
                :class="mostRecentMOT.TestResult === 'Pass' ? 'bg-[#0DB31E]' : 'bg-red-600'">
