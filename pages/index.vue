  ...
  <div>
    ...
    <section>
      <div class="mx-auto max-w-screen-2xl">
        <div class="bg-[#EEEEEE] lg:px-[10.7rem] 3xl:px-0 md:px-44 px-10">
          ...
          <div
            ...
            <p class="mt-8 text-xl font-extralight">After the 48-hour trial period expires, unless you cancel, you'll be
              ...
              monthly
              membership.</p>
            <p class="mt-10 text-2xl font-bold">This entitles you to make 7 full reports for £39.95 per month - only
              £5.70
              per
              report!
            </p>
